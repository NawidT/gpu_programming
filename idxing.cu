...
__global__ void whoami(void) {
    int block_id = // where in the 3d virtualization of the GPU is ur block + building analogy below
    ...
    int thread_offset = // similar, but threads (CuDA cores) within a Block (SM)
        threadIdx.x +  
